...
import com.sideprojects.unrepentantwaiting.actors.*;
import com.sideprojects.unrepentantwaiting.fantasyobjects.*;
...
public class Loop extends JFrame implements ActionListener {
	...
	private int modeDialog(JFrame frame) {
		...
		JOptionPane.showInternalConfirmDialog(frame, "Graphics?",
				"Graphics or Console?", JOptionPane.YES_NO_OPTION,
