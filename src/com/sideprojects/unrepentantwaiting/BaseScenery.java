 ...
 * and unbreakable cavern walls will implement this.
 * 
 * Most of the time, this should be used in a single class to describe an entire 
 * scene which implements this interface.  
 * 
 * @author woody
 *
 */
public interface BaseScenery 
{
	...
	public String getSpecial(BaseInteractable b); // For inspecting interactive items from the scene
