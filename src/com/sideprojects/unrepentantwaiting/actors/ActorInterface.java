...
public interface ActorInterface extends BaseInteractable
{
	...
	{
		MELEE_ATTACK, RANGED_ATTACK, MAGIC_ATTACK, MAGIC_EFFECT, USE_ROPE, ACROBATICS,
		PROFESSION, DIPLOMACY, BLUFF, SENSE_MOTIVE, PICK_LOCK, SET_TRAP, PERCEIVE_SOUND,
		PERCEIVE_LIGHT, PERCEIVE_SENT, CRAFT_ITEM, TRIP, HIDE, TRACK, GUESS, REMEMBER, 
		HAUL, PUSH_SELF, CALM_OTHER, BEAST_HANDLING, TRAIN_OTHER, TRAIN_ANIMAL, BARTER, 
		CHEAT, CONCEAL, AVOID_PANIC, ENDURE, CLOT, LUCK;
	}
	
	public enum SkillEnhancement
	{
		USEABLE, UNUSEABLE, COMBAT, NONCOMBAT, MAGICAL, ANTIMAGICAL, USES_ADDITIONAL_SKILL, 
		REPLACES_SKILL, CRITICAL, LIMITED_USE, FROM_RACE, FROM_CLASS, FROM_EQUIPMENT, 
		TEMPORARY, IGNORES_ATTRIBUTE, IGNORES_ARMOR, IGNORES_LANGUAGE, 
		POWERFUL, VERY_POWERFUL, EPIC, WEAK, VERY_WEAK, INEFFECTIVE,
		EVIL_TOUCHED, GOOD_TOUCHED, CHAOTIC_TOUCHED, LAWFUL_TOUCHED, VAMPIRIC,
		FIRE_TOUCHED, ICE_TOUCHED, LIGHTNING_TOUCHED, ACID_TOUCHED, SOUND_TOUCHED,
		AIR_TOUCHED, EARTH_TOUCHED, LIGHT_TOUCHED, DARK_TOUCHED, WATER_TOUCHED,
		PLANT_TOUCHED, FEY_TOUCHED, 
		UNWORLDLY, ETHEREAL, CELESTIAL, INFERNAL, ABYSSAL, UNREAL, EXTRA_REAL,
		STORY_MAIN, STORY_SIDE,
		SLASHING, BLUDGEONING, PIERCING, STOPPING, MOVING, SLICK, STICKY, STRANGE;
	}
