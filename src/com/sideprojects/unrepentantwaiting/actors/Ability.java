...
public abstract class Ability extends Named {
	 ...
	 * getScore()
	 * 
	 * Should have checks to see if i_score is initialized, and perhaps that the
	 * asker has that kind of permission.
	 * 
	 ...
	 * setAbility
	 * 
	 * Sets this ability's name. Does not change once it has been set.
	 * 
	 * @param an
	 */
	public void setAbility(AbilityName an) {
		if (!b_nameInitialized) {
			...
			System.out
					.println("Invalid ability name request; Ability already initialized!");
			return;
		}
	}
