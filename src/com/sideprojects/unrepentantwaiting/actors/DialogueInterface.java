 ...
 * can be then attached to any NPC (or other object that can hold a DialogueInterface)
 * and will smartly change their type, language, jargon, etc. to appropriate values
 * depending on what the owner is.  For instance, one could make a ShopDialogue object
 * once, and place it both on a dragon sailor and on a duergar, both of which would then
 * have similar responses, but may say them in different languages, temperance, and jargon.
 * 
 * @author wphillips
 *
 */
